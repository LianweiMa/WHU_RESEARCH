================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : DEM_Compare Project Overview
===============================================================================

The application wizard has created this DEM_Compare application for
...
DEM_CompareDlg.h, DEM_CompareDlg.cpp - the dialog
    ...
    in DEM_Compare.rc, which can be edited in Microsoft Visual C++.
